...
Let $\{x_i\mid i=1,\dots, n\} \in \mathcal{X}^n$ a sample of observation in the sample space $\mathcal{X}$, we often want to compute an estimation of a  parameter $\theta \in \E$, such parameter being a discriminant feature for a given problem of interest. 
